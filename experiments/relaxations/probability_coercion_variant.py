"""Variant probability-valued SHA-256 relaxation.

This experiment adds input coercion and uses an absolute-value approximation
for ``NOT``. It is archived research code, not a supported hash implementation.
"""
...
def coerce(tens):
    #return 1.0/  ( 1.0+torch.exp((coerce_steepness*tens) - coerce_offset) )
    # This is equivalent to sigmoid but for numerical stability this is safer
    #return tens#.clamp(0.0,1.0)
...
class ProbabilityCoercionVariantSHA256:
    def __init__(self):
        self.K = [
