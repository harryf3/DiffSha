"""Probability-valued SHA-256 relaxation with sigmoid-like coercion.

Archived exploratory code. Unlike the supported implementation, this module is
not guaranteed to reproduce SHA-256 for binary inputs.
"""
...
class ProbabilityCoercionSHA256:
    def __init__(self):
        self.K = [
